 ...
 * method for game logic, a {@link Entity#render() render()} method to organize calls to the graphics API, and a {@link Entity#destroy() destroy()} method to 
 * facilitate resource deallocation after an entity is no longer needed. 
 * <p>
