...
public final class Texture {
    ...
    public Texture(String filename) {
        ...
        try(InputStream file = Texture.class.getResourceAsStream("/theskidster/" + App.DOMAIN + "/assets/" + filename)) {
            loadTexture(file);
        } catch(Exception e) {
            Logger.setStackTrace(e);
            Logger.log(LogLevel.WARNING, "Failed to load texture: \"" + filename + "\"");
            
            loadTexture(Texture.class.getResourceAsStream("/theskidster/" + App.DOMAIN + "/assets/img_null.png"));
        }
