...
import static theskidster.xjge.hardware.InputDevice.KEYBOARD;
...
/**
 * Defines how input data supplied from a users {@link theskidster.xjge.hardware.InputDevice InputDevice} should be utilized in relation to the control of the 
 * implementing object.
 * 
 * @see Puppet
 */
