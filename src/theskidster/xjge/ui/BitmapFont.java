...
import theskidster.xjge.graphics.Instance;
import theskidster.xjge.graphics.Cell;
import theskidster.xjge.graphics.Texture;
...
public class BitmapFont {
     ...
     * {@link theskidster.xjge.graphics.SpriteSheet SpriteSheet}.
     * 
    ...
    public BitmapFont(String filename) {
        ...
        try {
            XMLStreamReader xmlReader = XMLInputFactory.newInstance()
                    .createXMLStreamReader(BitmapFont.class.getResourceAsStream("/theskidster/" + App.DOMAIN + "/assets/" + filename));
